...
public class AgiCommandFactory {
    ...
    public AgiCommand createAnswer() {
        return new AgiCommand() {
                ...
                public String buildCommand() {
                    String cmd = buildString(CommandEnum.ANSWER, null);
    ...
    public AgiCommand createGetChannelStatus() {
        return new AgiCommand() {
                @Override
                public String buildCommand() {
                    String cmd = buildString(CommandEnum.CHANNEL_STATUS, null);
    ...
    public AgiCommand createGetData(final String file) {
        return new AgiCommand() {
                ...
                public String buildCommand() {
                    Object[] params = { file };
                    String cmd = buildString(CommandEnum.GET_DATA, params);
    ...
    public AgiCommand createGetOption(final String file,
        ...
        return new AgiCommand() {
                ...
                public String buildCommand() {
                    Object[] params = { file, timeout };
                    String cmd = buildString(CommandEnum.GET_OPTION, params);
    ...
    public AgiCommand createHangup() {
        return new AgiCommand() {
                @Override
                public String buildCommand() {
                    String cmd = buildString(CommandEnum.HANGUP, null);
    ...
    public AgiCommand createReceiveChar(final int timeout) {
        return new AgiCommand() {
                @Override
                public String buildCommand() {
                    String cmd = buildString(CommandEnum.RECEIVE_CHAR, null);
    ...
    public AgiCommand createReceiveText(final int timeout) {
        return new AgiCommand() {
                @Override
                public String buildCommand() {
                    String cmd = buildString(CommandEnum.RECEIVE_TEXT, null);
    ...
    public AgiCommand createRecordFile(final String file, final String format,
        ...
        return new AgiCommand() {
                ...
                public String buildCommand() {
                    ...
                    String cmd = buildString(CommandEnum.RECORD_FILE, params);
    ...
    public AgiCommand createSayAlpha(final String text) {
        return new AgiCommand() {
                ...
                public String buildCommand() {
                    Object[] params = { text, "" };
                    String cmd = buildString(CommandEnum.SAY_ALPHA, params);
    ...
    public AgiCommand createSayDigits(final String text) {
        return new AgiCommand() {
                ...
                public String buildCommand() {
                    Object[] params = { text, "" };
                    String cmd = buildString(CommandEnum.SAY_DIGITS, params);
    ...
    public AgiCommand createSayNumber(final String text) {
        return new AgiCommand() {
                ...
                public String buildCommand() {
                    Object[] params = { text, "" };
                    String cmd = buildString(CommandEnum.SAY_NUMBER, params);
    ...
    public AgiCommand createSayPhonetic(final String text) {
        return new AgiCommand() {
                ...
                public String buildCommand() {
                    Object[] params = { text, "" };
                    String cmd = buildString(CommandEnum.SAY_PHONETIC, params);
    ...
    public AgiCommand createSayDate(final long time, final String escapeDigits) {
        return new AgiCommand() {
                ...
                public String buildCommand() {
                    ...
                    String cmd = buildString(CommandEnum.SAY_DATE, params);
    ...
    public AgiCommand createSayTime(final long time, final String escapeDigits) {
        return new AgiCommand() {
                ...
                public String buildCommand() {
                    Object[] params = { time, escapeDigits };
                    String cmd = buildString(CommandEnum.SAY_TIME, params);
    ...
    public AgiCommand createSayDateTime(final long time,
        ...
        return new AgiCommand() {
                ...
                public String buildCommand() {
                    ...
                    String cmd = buildString(CommandEnum.SAY_DATETIME, params);
    ...
    public AgiCommand createSendImage(final String image) {
        return new AgiCommand() {
                ...
                public String buildCommand() {
                    Object[] params = { image };
                    String cmd = buildString(CommandEnum.SEND_IMAGE, params);
    ...
    public AgiCommand createSetContext(final String context) {
        return new AgiCommand() {
                ...
                public String buildCommand() {
                    ...
                    String cmd = buildString(CommandEnum.SET_CONTEXT, params);
    ...
    public AgiCommand createSetExtension(final String extension) {
        return new AgiCommand() {
                ...
                public String buildCommand() {
                    ...
                    String cmd = buildString(CommandEnum.SET_EXTENSION, params);
    ...
    public AgiCommand createSetPriority(final String priority) {
        return new AgiCommand() {
                ...
                public String buildCommand() {
                    ...
                    String cmd = buildString(CommandEnum.SET_PRIORITY, params);
    ...
    public AgiCommand createSetAutoHangup(final int time) {
        return new AgiCommand() {
                ...
                public String buildCommand() {
                    Object[] params = { time };
                    String cmd = buildString(CommandEnum.SET_AUTOHANGUP, params);
    ...
    public AgiCommand createStreamFile(final String file,
        ...
        return new AgiCommand() {
                ...
                public String buildCommand() {
                    ...
                    String cmd = buildString(CommandEnum.STREAM_FILE, params);
    ...
    public AgiCommand createControlStreamFile(final String file) {
        return new AgiCommand() {
                ...
                public String buildCommand() {
                    ...
                    String cmd = buildString(CommandEnum.CONTROL_STREAM_FILE,
                            params);
    ...
    public AgiCommand createWaitForDigit(final int interDigitsTimeout) {
        return new AgiCommand() {
                ...
                public String buildCommand() {
                    ...
                    String cmd = buildString(CommandEnum.WAIT_FOR_DIGIT, params);
    ...
    public AgiCommand createSpeechCreate(final String engine) {
        return new AgiCommand() {
                ...
                public String buildCommand() {
                    ...
                    String cmd = buildString(CommandEnum.SPEECH_CREATE, params);
    ...
    public AgiCommand createSpeechLoadGrammar(final String label,
        ...
        return new AgiCommand() {
                ...
                public String buildCommand() {
                    ...
                    String cmd = buildString(CommandEnum.SPEECH_LOAD_GRAMMAR,
                            params);
    ...
    public AgiCommand createSpeechActivateGrammar(final String label) {
        return new AgiCommand() {
                ...
                public String buildCommand() {
                    Object[] params = { label };
                    String cmd = buildString(CommandEnum.SPEECH_ACTIVATE_GRAMMAR,
                            params);
    ...
    public AgiCommand createSpeechDeactivateGrammar(final String label) {
        return new AgiCommand() {
                ...
                public String buildCommand() {
                    Object[] params = { label };
                    String cmd = buildString(CommandEnum.SPEECH_DEACTIVATE_GRAMMAR,
                            params);
    ...
    public AgiCommand createGoSub(final String context, final String extension,
        ...
        return new AgiCommand() {
                ...
                public String buildCommand() {
                    ...
                    String cmd = buildString(CommandEnum.GOSUB, params);
    ...
    private String buildString(CommandEnum command, Object[] parameters) {
