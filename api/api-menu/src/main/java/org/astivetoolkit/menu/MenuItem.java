...
/**
 * All items in a menu must belong to the class <code>MenuItem</code>, 
 * or one of its subclasses. 
 *
 * <p>When a menu item is selected, ATK sends an action event to the menu item. 
 * Since the event is an instance of ActionEvent, the method {@link #processAction}
 * redirects the event to any ActionListener objects that have registered 
 * an interest in action events generated by this menu item. 
 * 
 * @since 1.0.0
 * @see Menu
 */
public class MenuItem {
  ...
  /**
   * Creates a new MenuItem object with <code>digits</code> and <code>file</code>
   * as parameters.
   * 
  ...
  /**
   * Registers the specified action listener to receive action events from this 
   * menu item. If <code>listener</code> is null, no exception is thrown and no 
   * action is performed. 
   * 
  ...
  /**
   * Registers the specified authentication listener to receive authentication events
   * from this menu item. 
   * 
   * @param listener the object that receives a notification when an event of 
   * the specified type occurs.
  ...
  /**
   * Registers the specified digits listener to receive digits events from this 
   * menu item.
   * 
   * @param listener the object that receives a notification when an event of 
   * the specified type occurs.
  ...
  /**
   * Registers the specified key listener to receive key events from this menu item.  
   * 
   * @param listener the object that receives a notification when an event of 
   * the specified type occurs.
   */
   ...
   * events from this menu item. If <code>listener</code> is null, no exception 
  ...
  /**
   * Registers a voice composition. If <code>file</code> is not NULL, it takes
   * precedence over the voice composition.
   * 
  ...
  /**
   * Returns false if desire to maintain authentication for a <code>Subject</code>
   * 
  ...
  /**
   * Returns an array of all the voice compositions registered on this menu item. 
   * 
   * @return all of this menu item's voice compositions or an empty array if no 
   * voice compositions are currently registered.
   */
   ...
   * 
   * @param forgetAuthOnLeave by default authentication is temporally save base 
   * on callerId.
   */
