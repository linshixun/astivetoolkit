...
public class URLValidator {
     ...
     * Use for exact match.
     */
    public static final Pattern SLASH_SLASH_ASTIVLET = Pattern.compile("^\\/[-a-zA-Z0-9][-a-zA-Z0-9+&@#/%?=~_|!:,.;]");
    /**
     ...
     */
    public static final Pattern ASTERISK_EXTENSION = Pattern.compile("^\\*.[-a-zA-Z0-9+&@#/%?=~_|!:,.;]");
