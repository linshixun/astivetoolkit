...
public class Menu extends MenuItem {
  ...
  private ArrayList<InterDigitsTimeoutListener> interDigitsTimeoutListenerList =
    new ArrayList<InterDigitsTimeoutListener>();
  private ArrayList<MaxFailureListener> maxFailureListenerList =
    new ArrayList<MaxFailureListener>();
  private ArrayList<MaxTimeoutListener> maxTimeoutListenerList =
    new ArrayList<MaxTimeoutListener>();
  private ArrayList<PositionChangeListener> positionChangeListenerList =
    new ArrayList<PositionChangeListener>();
   ...
   * {@inheritDoc}
   */
  public Menu(final String digits, final String file, final Action action, final int priority) {
